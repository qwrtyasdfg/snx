...
This issue tracker is only for technical issues related to snx Core.
General snx questions and/or support requests and are best directed to the [snx Slack](http://snx.slack.com).
...
### What version of snx Core are you using?
