/* src/config/snx-config.h.  Generated from snx-config.h.in by configure.  */
/* src/config/snx-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.snxcoin.info"

/* Define to the full name of this package. */
#define PACKAGE_NAME "snx Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "snx Core 2.4.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "snx"
