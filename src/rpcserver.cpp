...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* snx features */
        {"snx", "masternode", &masternode, true, true, false},
        {"snx", "masternodelist", &masternodelist, true, true, false},
        {"snx", "mnbudget", &mnbudget, true, true, false},
        {"snx", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"snx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"snx", "mnsync", &mnsync, true, true, false},
        {"snx", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"snx", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use snxd, or the -server option to snx-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> snx-cli " + methodname + " " + args + "\n";
}
