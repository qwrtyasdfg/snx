                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("snx Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a snx address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and snx: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About snx Core"), this);
    aboutAction->setStatusTip(tr("Show information about snx Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for snx"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your snx addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified snx addresses"));
    ...
    openAction->setStatusTip(tr("Open a snx: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the snx Core help message to get a list with possible snx command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("snx Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to snx network", "", count));
}
...
{
    QString strTitle = tr("snx Core"); // default title
