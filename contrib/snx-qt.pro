...
RESOURCES += src/qt/snx.qrc src/qt/snx_locale.qrc

TRANSLATIONS += src/qt/locale/snx_bg.ts \
                src/qt/locale/snx_de.ts \
                src/qt/locale/snx_en.ts \
                src/qt/locale/snx_es.ts \
                src/qt/locale/snx_fi.ts \
                src/qt/locale/snx_fr.ts \
                src/qt/locale/snx_it.ts \
                src/qt/locale/snx_ja.ts \
                src/qt/locale/snx_pl.ts \
                src/qt/locale/snx_pt.ts \
                src/qt/locale/snx_ru.ts \
                src/qt/locale/snx_sk.ts \
                src/qt/locale/snx_sv.ts \
                src/qt/locale/snx_vi.ts \
                src/qt/locale/snx_zh_CN.ts \
                src/qt/locale/snx_zh_TW.ts
