Contributing to snx Core
============================

The snx Core project operates an open contributor model where anyone is
...
The following applies to code changes to the snx Core project, and is not to be
confused with overall snx Network Protocol consensus changes.

Whether a pull request is merged into snx Core rests with the project merge
...
Patches that change snx consensus rules are considerably more involved than
...
Where a patch set proposes to change the snx consensus, it must have been
...
The project leader is the release manager for each snx Core release.
