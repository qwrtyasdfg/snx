...
In order to support loading of multiple wallets in snx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is snx.cpp.
...
Changes to snx.cpp
----------------------
snx.cpp is the entry point into snx-qt, and as such, will require some minor modifications to provide hooks for
