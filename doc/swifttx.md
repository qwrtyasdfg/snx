...
This mechanism has been integrated into Bitcore-Node-snx which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/snx-Project/insight-api-snx#web-socket-api](https://github.com/snx-Project/insight-api-snx#web-socket-api) 
* API: [https://github.com/snx-Project/insight-api-snx#swifttx-transactions](https://github.com/snx-Project/insight-api-snx#swifttx-transactions) 
...
By default, the snx Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the snx Core daemon:
